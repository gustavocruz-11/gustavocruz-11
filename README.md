...
Atualmente, estou focado em aprender as melhores práticas de programação e arquitetura de software no **SENAI**. Sou um entusiasta da tecnologia em busca de transformar ideias em linhas de código eficientes.

---

### 🚀 Sobre mim
- 🎓 Cursando **Técnico em Desenvolvimento de Sistemas** no SENAI.
- 🔭 Atualmente trabalhando em projetos acadêmicos e explorando o mundo do desenvolvimento.
- 🌱 Aprendendo diariamente sobre Lógica de Programação, Banco de Dados e Desenvolvimento Web.
